    ...
    */
    , manageValidationResult: function () {
      ...
      if ( true === this.valid ) {
        ...
        //   }
        // }
        var constraint=errors[0];
        var constraintName = constraint.name
        var message = false !== this.options.errorMessage ? this.options.errorMessage : ( constraint.name === 'type' ?
        ...
        if(typeof window.parsleyAlert!="undefined"){
          window.parsleyAlert(message);
        }else{
          alert(message);
        }
